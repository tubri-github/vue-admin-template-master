    ...
    <el-card class="details-section">
      ...
      <div class="details-content">
        ...
        <div v-if="hasMetadata" class="metadata-section">
          ...
          <el-row :gutter="20">
            <el-col v-if="species.CreatedDate" :span="12">
              <div class="detail-item">
                <label>Created:</label>
                <span class="detail-value">{{ formatDate(species.CreatedDate) }}</span>
              </div>
            </el-col>
            <el-col v-if="species.ModifiedDate" :span="12">
              <div class="detail-item">
          ...
          <el-row v-if="species.CreatedBy || species.ModifiedBy" :gutter="20">
            <el-col v-if="species.CreatedBy" :span="12">
              <div class="detail-item">
                <label>Created By:</label>
                <span class="detail-value">{{ species.CreatedBy }}</span>
              </div>
            </el-col>
            <el-col v-if="species.ModifiedBy" :span="12">
              <div class="detail-item">
    ...
    <el-card class="details-section">
      ...
      <div class="details-content">
        ...
        <div v-else class="loading-stats">
          <el-button :loading="loadingStats" @click="loadSpecimenRecords">
