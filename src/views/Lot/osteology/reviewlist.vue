<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form ref="form" :model="searchForm" label-width="120px">
        <el-form-item label="Previous Catalog Number">
          <el-input v-model="searchForm.prevNumber" style="width: 350px;" placeholder="Prev Catalogs(Use “,” to separate multiple numbers)" />
        </el-form-item>
        ...
        <el-form-item label="Total Number">
          <el-col :span="5">
            <el-input type="number" :min="0" v-model.number="searchForm.minNum" />
          </el-col>
          <el-col :span="2" class="line"> - </el-col>
          <el-col :span="5">
            <el-input type="number" :max="10000" v-model.number="searchForm.maxNum" />
          </el-col>
    ...
    >
      <el-table-column label="Prev Catalog Number" prop="id" sortable="custom" align="center">
...
<!--          <span>{{ row.collectordate | parseTime('{y}-{m}-{d}') }}</span>-->
      ...
      <el-table-column label="Actions" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button type="primary" size="mini" @click="handleUpdate(row)" disabled>
            Edit
          </el-button>
